...
Adapter evidence reports the effective child idle, active-operation, absolute,
and outer watchdog values. The process collection path uses those state-aware
watchdogs directly.
