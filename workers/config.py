...
RUNTIME_ROOT = _path("DEPUTYWORKERS_RUNTIME_ROOT", ROOT / "runtime")
DEPUTY_SHELL_ROOT = _path("DEPUTYWORKERS_DEPUTY_SHELL_ROOT", ROOT / "deputy-shell-source")
ANDROID_SDK_ROOT = _path("DEPUTYWORKERS_ANDROID_SDK_ROOT", ROOT / "android-sdk")
